...
INSERT INTO `hazard_site` (`id_site`, `site`) VALUES
(1, 'I'),
(2, 'Q'),
(3, 'T'),
(4, 'E'),
...
--
-- Struktur dari tabel `pit`
--

CREATE TABLE `hazard_pit` (
...
--
-- Dumping data untuk tabel `pit`
--

INSERT INTO `hazard_pit` (`id_pit`, `pit`, `id_kecamatan`) VALUES
(1, 'Ciputat', 1),
(2, 'Cipayung', 1),
(3, 'Serua', 1),
(4, 'Sawah Lama', 1),
